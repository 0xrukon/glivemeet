...
public class Demo_contents {
    ...
    public static ArrayList<String> girlsImage = new ArrayList<>(Arrays.asList(
            ...
            "https://i0.wp.com/www.goodfreephotos.com/albums/people/beautiful-girl-with-long-hair-and-pretty-eyes.jpg?ssl=1",
            "https://avatars.mds.yandex.net/i?id=1491e30c366b9d23924e059907c9639f928c884a-4772468-images-thumbs&n=13",
            "https://img5.goodfon.com/wallpaper/nbig/9/7a/devushka-vzgliad-poza-lestnitsa.jpg",
            "https://www.stockinvestor.com/wp-content/uploads/2016/05/Free-College.jpg",
            "https://avatars.mds.yandex.net/i?id=e900a35b2835a886346304f9ee6de07889d7df5a61b7f923-3947589-images-thumbs&n=13",
            "https://i.pinimg.com/originals/cd/83/69/cd8369a8808509de674964b8215dc540.jpg",
            "https://iv1.lisimg.com/image/19382341/740full-anastasia-shcheglova.jpg",
            "https://i.pinimg.com/originals/34/9c/70/349c70ed8a390709706a601e967a54cb.jpg",
            "https://www.bellazon.com/main/uploads/monthly_2017_05/040.jpg.a5e3d9e4acce14912f121ad7667c1459.jpg",
            "https://cdn1.ozone.ru/s3/multimedia-q/6092312774.jpg"
    ));
  ...
  /*  public static List<Sticker_dummy> getStickers() {
    ...
    public static List<UserRoot.User> getUsers(boolean isShuffle) {
        ...
        Collections.shuffle(girlsImage);
    ...
    public static List<LiveStramComment> getLiveStreamComment() {
        ...
        liveStramCommentDummies.add(new LiveStramComment("", getUsers(true).get(0), true, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("", getUsers(true).get(0), true, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("", getUsers(true).get(0), true, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("", getUsers(true).get(0), true, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("", getUsers(true).get(0), true, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Please stop looking so hot every time.", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Looking very very hot\uD83D\uDD25in summer", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Your queenly smiles are what my eyes have been longing to see.", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Too hot for me to handle", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Every single part of your body was made according to my spec.", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("I drop my cap for you.", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Your hotness is just beating me everytim.", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Classy shot and awesome background too.", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Hello dear,", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("Give me your mobile number", getUsers(true).get(0), false, "", "", "comment", ""));
        liveStramCommentDummies.add(new LiveStramComment("9975537455 it is my mobile number", getUsers(true).get(0), false, "", "", "comment", ""));
